...
if not getgenv().Hack or getgenv().Hack.Aimbot then return end
...
local Environment = getgenv().Hack.Aimbot
...
local function GetClosestPlayer()
	if not Environment.Locked then
		...
		for _, v in next, workspace.Monsters:GetChildren() do
...
function Environment.Functions:Exit()
	...
	getgenv().Hack.Aimbot.Functions = nil
	getgenv().Hack.Aimbot = nil
